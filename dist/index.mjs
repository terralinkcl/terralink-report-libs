...
function Fotos({ s, fotos }) {
  return /* @__PURE__ */ jsx(View, { style: s.fotos, children: fotos.map((f, i) => /* @__PURE__ */ jsxs(View, { style: s.fbox, wrap: false, children: [
    /* @__PURE__ */ jsx(Image, { style: s.foto, src: f.url }),
    f.caption ? /* @__PURE__ */ jsx(Text, { style: s.cap, children: f.caption }) : null
  ] }, i)) });
}
function Datos({ s, theme, items }) {
  if (theme.datosVariant === "tarjetas") {
    return /* @__PURE__ */ jsx(View, { style: s.cards, children: items.map((d, i) => /* @__PURE__ */ jsx(View, { style: s.card, children: /* @__PURE__ */ jsxs(View, { style: s.cardIn, children: [
      /* @__PURE__ */ jsx(Text, { style: s.cardLab, children: d.label }),
      /* @__PURE__ */ jsx(Text, { style: s.cardVal, children: d.value })
    ] }) }, i)) });
  }
  if (theme.datosVariant === "tabla") {
    const rows = [];
    for (let i = 0; i < items.length; i += 2) rows.push(items.slice(i, i + 2));
    return /* @__PURE__ */ jsx(View, { style: s.table, children: rows.map((pair, i) => /* @__PURE__ */ jsxs(View, { style: s.tRow, children: [
      /* @__PURE__ */ jsx(Text, { style: s.tTh, children: pair[0].label }),
      /* @__PURE__ */ jsx(Text, { style: pair[1] ? s.tTd : s.tTdLast, children: pair[0].value }),
      pair[1] ? /* @__PURE__ */ jsx(Text, { style: s.tTh, children: pair[1].label }) : null,
      pair[1] ? /* @__PURE__ */ jsx(Text, { style: s.tTdLast, children: pair[1].value }) : null
    ] }, i)) });
  }
  return /* @__PURE__ */ jsx(View, { style: s.fichas, children: items.map((d, i) => /* @__PURE__ */ jsxs(View, { style: s.fichaItem, children: [
    /* @__PURE__ */ jsx(Text, { style: s.fichaLab, children: d.label }),
    /* @__PURE__ */ jsx(Text, { style: s.fichaVal, children: d.value })
  ] }, i)) });
}
function SeccionHead({ s, theme, num, titulo }) {
  if (theme.h1Variant === "chip") {
    return /* @__PURE__ */ jsxs(View, { style: s.h1Chip, children: [
      /* @__PURE__ */ jsx(Text, { style: s.h1ChipBox, children: num }),
      /* @__PURE__ */ jsx(Text, { style: s.h1ChipT, children: titulo })
    ] });
  }
  if (theme.h1Variant === "barra") {
    return /* @__PURE__ */ jsxs(View, { style: s.h1Barra, children: [
      /* @__PURE__ */ jsx(Text, { style: s.h1BarraN, children: `${num}.0` }),
      /* @__PURE__ */ jsx(Text, { style: s.h1BarraT, children: titulo })
    ] });
  }
  return /* @__PURE__ */ jsxs(View, { style: s.h1Numero, children: [
    /* @__PURE__ */ jsx(Text, { style: s.h1NumeroN, children: num }),
    /* @__PURE__ */ jsx(Text, { style: s.h1NumeroT, children: titulo })
  ] });
}
function Subseccion({ s, num, ss }) {
  return /* @__PURE__ */ jsxs(View, { style: { marginBottom: 12 }, children: [
    ss.titulo ? /* @__PURE__ */ jsxs(View, { style: s.h2Wrap, children: [
      /* @__PURE__ */ jsx(View, { style: s.h2Tick }),
      /* @__PURE__ */ jsx(Text, { style: s.h2Num, children: num }),
      /* @__PURE__ */ jsx(Text, { style: s.h2, children: ss.titulo })
    ] }) : null,
    ss.kpis && ss.kpis.length > 0 ? /* @__PURE__ */ jsx(View, { style: s.kpis, children: ss.kpis.map((it, i) => /* @__PURE__ */ jsxs(View, { style: s.kpi, children: [
      /* @__PURE__ */ jsx(Text, { style: s.kpiV, children: it.v }),
      /* @__PURE__ */ jsx(Text, { style: s.kpiK, children: it.k })
    ] }, i)) }) : null,
    (ss.parrafos ?? []).map((p, i) => /* @__PURE__ */ jsx(Text, { style: s.body, children: p }, i)),
    ss.lista && ss.lista.length > 0 ? /* @__PURE__ */ jsx(View, { style: { marginBottom: 6 }, children: ss.lista.map((it, i) => /* @__PURE__ */ jsxs(View, { style: s.li, children: [
      /* @__PURE__ */ jsx(Text, { style: s.liDot, children: "\u2014" }),
      /* @__PURE__ */ jsx(Text, { style: s.liTxt, children: it })
    ] }, i)) }) : null,
    ss.fotos && ss.fotos.length > 0 ? /* @__PURE__ */ jsx(Fotos, { s, fotos: ss.fotos }) : null
  ] });
}
...
function NetworkPattern({
  ...
  return /* @__PURE__ */ jsxs2(Svg, { viewBox, preserveAspectRatio: "xMidYMid slice", style, children: [
    LINES.map(([x1, y1, x2, y2], i) => /* @__PURE__ */ jsx2(
      Line,
      {
        x1,
        y1,
    ...
    NODES.map(([cx, cy, r], i) => /* @__PURE__ */ jsx2(Circle, { cx, cy, r, fill: nodeColor, fillOpacity: nodeOpacity }, `n${i}`)),
    ACCENTS.map(([cx, cy, r], i) => /* @__PURE__ */ jsx2(Circle, { cx, cy, r, fill: accentColor, fillOpacity: accentOpacity }, `a${i}`))
  ] });
}

// src/CoverPage.tsx
import { Page, Text as Text2, View as View2, Image as Image2 } from "@react-pdf/renderer";
...
function CoverPage({
  ...
  const metaItem = (lab, val) => val ? /* @__PURE__ */ jsxs3(View2, { style: s.coverMetaItem, children: [
    /* @__PURE__ */ jsx3(Text2, { style: s.coverMetaLab, children: lab }),
    /* @__PURE__ */ jsx3(Text2, { style: s.coverMetaVal, children: val })
  ] }) : null;
  return /* @__PURE__ */ jsxs3(Page, { size: "A4", style: s.cover, children: [
    theme.coverPattern ? /* @__PURE__ */ jsx3(
      NetworkPattern,
      {
    ...
    /* @__PURE__ */ jsx3(View2, { style: s.coverRule }),
    theme.coverDark ? /* @__PURE__ */ jsx3(View2, { style: s.coverLogoChip, children: /* @__PURE__ */ jsx3(Image2, { style: s.coverLogoChipImg, src: logo }) }) : (
      // eslint-disable-next-line jsx-a11y/alt-text
      /* @__PURE__ */ jsx3(Image2, { style: s.coverLogo, src: logo })
    ),
    /* @__PURE__ */ jsx3(Text2, { style: s.coverEyebrow, children: meta.eyebrow }),
    /* @__PURE__ */ jsx3(Text2, { style: s.coverTitle, children: meta.titulo }),
    meta.subtitulo ? /* @__PURE__ */ jsx3(Text2, { style: s.coverSub, children: meta.subtitulo }) : null,
    /* @__PURE__ */ jsx3(View2, { style: s.spacer }),
    /* @__PURE__ */ jsxs3(View2, { style: s.coverMeta, children: [
    ...
    /* @__PURE__ */ jsx3(Text2, { style: s.coverFoot, children: "Terralink O&M  \xB7  Documento de uso interno  \xB7  Operaci\xF3n y Mantenimiento" })
  ] });
}

// src/ReporteDocument.tsx
import { Document, Page as Page2, Text as Text3, View as View3 } from "@react-pdf/renderer";
...
function ReporteDocument({
  ...
  return /* @__PURE__ */ jsxs4(Document, { children: [
    /* @__PURE__ */ jsx4(CoverPage, { s, theme, meta, logo }),
    /* @__PURE__ */ jsxs4(Page2, { size: "A4", style: s.page, children: [
      /* @__PURE__ */ jsxs4(View3, { style: s.runHead, fixed: true, children: [
        /* @__PURE__ */ jsx4(Text3, { style: s.runHeadT, children: meta.titulo }),
        /* @__PURE__ */ jsx4(Text3, { style: s.runHeadT, children: meta.planta })
      ] }),
      /* @__PURE__ */ jsxs4(View3, { style: s.footer, fixed: true, children: [
        /* @__PURE__ */ jsx4(Text3, { style: s.footerT, children: meta.codigo ? `${meta.codigo}  \xB7  Terralink O&M` : "Terralink O&M" }),
        /* @__PURE__ */ jsx4(
          Text3,
          {
            style: s.footerT,
      ...
      /* @__PURE__ */ jsx4(Text3, { style: s.tocKicker, children: "Contenido" }),
      /* @__PURE__ */ jsx4(Text3, { style: s.tocTitle, children: "\xCDndice" }),
      /* @__PURE__ */ jsx4(View3, { style: { marginTop: 10 }, children: toc.map(
        (r, i) => r.nivel === 1 ? /* @__PURE__ */ jsxs4(View3, { style: s.tocRow1, children: [
          /* @__PURE__ */ jsx4(Text3, { style: s.tocNum1, children: r.num }),
          /* @__PURE__ */ jsx4(Text3, { style: s.tocT1, children: r.titulo }),
          tocPageNumbers ? /* @__PURE__ */ jsx4(View3, { style: s.leader }) : null,
          tocPageNumbers ? /* @__PURE__ */ jsx4(Text3, { style: s.tocPage1, children: `${r.page}` }) : null
        ] }, i) : /* @__PURE__ */ jsxs4(View3, { style: s.tocRow2, children: [
          /* @__PURE__ */ jsx4(Text3, { style: s.tocNum2, children: r.num }),
          /* @__PURE__ */ jsx4(Text3, { style: s.tocT2, children: r.titulo }),
          tocPageNumbers ? /* @__PURE__ */ jsx4(View3, { style: s.leader }) : null,
          tocPageNumbers ? /* @__PURE__ */ jsx4(Text3, { style: s.tocPage2, children: `${r.page}` }) : null
        ] }, i)
      ) }),
      data.secciones.map((sec, i) => /* @__PURE__ */ jsxs4(View3, { break: true, children: [
        /* @__PURE__ */ jsx4(SeccionHead, { s, theme, num: `${i + 1}`, titulo: sec.titulo }),
        sec.sub.map((ss, j) => /* @__PURE__ */ jsx4(Subseccion, { s, num: `${i + 1}.${j + 1}`, ss }, j))
      ] }, i))
    ] })
  ] });
}
...
import { Document as Document2, Page as Page3, Text as Text4, View as View4, Image as Image4 } from "@react-pdf/renderer";
...
function ReporteSimpleDocument({
  ...
  return /* @__PURE__ */ jsxs5(Document2, { children: [
    conPortada ? /* @__PURE__ */ jsx5(CoverPage, { s, theme, meta, logo }) : null,
    /* @__PURE__ */ jsxs5(Page3, { size: "A4", style: s.pageSimple, children: [
      /* @__PURE__ */ jsxs5(View4, { style: s.footerSimple, fixed: true, children: [
        /* @__PURE__ */ jsx5(Text4, { style: s.footerT, children: `${meta.codigo}  \xB7  Terralink O&M` }),
        /* @__PURE__ */ jsx5(
          Text4,
          {
            style: s.footerT,
      ...
      /* @__PURE__ */ jsxs5(View4, { style: s.sHead, children: [
        /* @__PURE__ */ jsx5(Image4, { style: s.sHeadLogo, src: logo }),
        /* @__PURE__ */ jsxs5(View4, { children: [
          /* @__PURE__ */ jsx5(Text4, { style: s.sHeadTag, children: "Informe de Mantenimiento" }),
          /* @__PURE__ */ jsx5(Text4, { style: s.sHeadTag2, children: "Operaci\xF3n y Mantenimiento" })
        ] })
      ] }),
      /* @__PURE__ */ jsx5(Text4, { style: s.sKicker, children: meta.eyebrow }),
      /* @__PURE__ */ jsx5(Text4, { style: s.sTitle, children: meta.titulo }),
      /* @__PURE__ */ jsx5(Datos, { s, theme, items: datos }),
      data.secciones.map((sec, i) => /* @__PURE__ */ jsxs5(View4, { style: { marginTop: i === 0 ? 0 : 6 }, children: [
